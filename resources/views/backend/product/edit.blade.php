    ...
    <div class="card-body">
      <form method="post" action="{{route('product.update',$product->id)}}">
        ...
        <div class="form-group">
          ...
          <input type="checkbox" name='is_featured' id='is_featured' value='1' {{(($product->is_featured==1)? 'checked' : '')}}> Yes                        
        ...
        <div class="form-group">
          <label for="price" class="col-form-label">Price(In PKR) <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          ...
          <input id="discount" type="number" name="discount" min="0" max="100" placeholder="Enter discount in percentage"  value="{{$product->discount}}" class="form-control">
          @error('discount')
          <span class="text-danger">{{$message}}</span>
          @enderror
        </div>
