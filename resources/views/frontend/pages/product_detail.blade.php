...
@endsection
@section('title','RCM || PRODUCT DETAIL')
										...
										<div class="product-des">
											...
											<div class="short">
												...
												<p class="price">
    												...
    												<s>Rs {{number_format($product_detail->price,2)}}</s>
												</p>
												@else
												    <p class="price">
												    <span class="discount">Rs {{number_format($product_detail->price ,2)}}</span>
                                                    </p>												
												@endif
											...
											<div class="product-buy">
												...
												<a href="{{route('product-cat',$product_detail->cat_info['slug'])}}">{{$product_detail->cat_info['title']}}</a></p>
												@else
												<p>No specific category</p>
												@endif
