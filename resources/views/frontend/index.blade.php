...
<div class="product-area section">
        ...
        <div class="section-title">
        <a href="{{url('product-grids')}}" class="btn btn-primary" >View All Products</a>
        </div>
</div>
<!-- End Product Area -->
        ...
        <div class="row">
            <div class="col-12">
                <div class="owl-carousel popular-slider">
                    @foreach($featured_list as $product)
        ...
        <div class="row">
            <div class="col-lg-12 col-md-12 col-12">
                ...
                <div class="row">
                    ...
                    @foreach($latest_list as $product)
                        <div class="col-md-4">
                            <!-- Start Single List  -->
