            ...
            <div class="row">
                <div class="col-lg-6 col-md-12 col-12">
                    ...
                    <div class="top-left">
                        <ul class="list-main">
                            @php
                                $settings=DB::table('settings')->get(['phone','email']);        
                            @endphp
                                ...
                                <div class="navbar-collapse">	
                                    <div class="nav-inner">	
                                        <ul class="nav main-menu menu navbar-nav">
                                            ...
                                            @else
                                                <li class="{{Request::path()=='user/register' || Request::path()=='user/login' ? 'active' : ''}}"><a href="{{route('register.form')}}">Login / Register</a></li>
                                            @endauth
